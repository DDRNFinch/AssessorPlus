const DATA_KEY = 'assessorPlusSimpleRegisterV3';
...
$('exportBackupButton').addEventListener('click',()=>download(`AssessorPlus-backup-${todayISO()}.json`,JSON.stringify({version:3,exportedAt:new Date().toISOString(),data:state},null,2),'application/json'));
